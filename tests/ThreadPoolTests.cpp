...
// future 就绪可能早于活动计数归零；以有限时间等待 worker 收尾。
...
// 用 promise 固定队列状态；ReleaseGuard 在退出测试时先放行 worker。
...
// ============================================================================
// 3. Status：队列、活动任务、worker 数量与运行状态
// ============================================================================

// 通过 promise 确认 worker 开始及放行，不依赖 sleep 猜测队列状态。
bool TestTaskCount() {
...
// ============================================================================
// 5. Exception：future 传递异常、worker 继续工作
// ============================================================================
...
// ============================================================================
// 7. RejectPolicy：Abort / CallerRuns / Discard
// ============================================================================
